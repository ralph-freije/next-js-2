    ...
    <section className="w-full bg-[#f3f3f3] py-16 md:py-20">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <button className="hidden cursor-pointer  md:block border border-[#17c58b] text-[#17c58b] px-5 py-2 rounded-[10px] text-[14px] font-medium hover:bg-[#17c58b] hover:text-white transition">
            Learn More
          </button>
        </div>
...
<div className=" cursor-pointer hover:bg-[#f3f3f3] grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-5 mt-10">
  ...
  {steps.map((step, i) => (
    <div
      key={i}
      className="bg-white hover:bg-[#f3f3f3] rounded-[16px] p-4 h-[170px] flex flex-col justify-start shadow-[0_6px_20px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] transition"
    >
      <div className="w-10 h-10 flex items-center justify-center rounded-[10px] bg-[#ecfdf5]">
        {step.icon}
      </div>
      ...
      <p className="mt-1.5 text-[13px] text-[#9ca3af] leading-[1.5] max-w-[160px] line-clamp-3">
        {step.desc}
      </p>
    </div>
  ))}
