      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-12">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-[55%] text-center md:text-left">
            ...
            <p className="mt-4 text-sm text-[#6b7280] leading-relaxed max-w-[420px] mx-auto md:mx-0">
            ...
            <button className="cursor-pointer mt-6 border border-[#17c58b] text-[#17c58b] px-5 py-2 rounded-[10px] text-sm font-medium hover:bg-[#17c58b] hover:text-white transition">
              Learn More
            </button>
          </div>
        </div>
