...
export default function JobPage() {
  ...
  return (
    <main className={`${poppins.className} bg-[#f3f3f3] overflow-x-hidden min-h-screen flex flex-col`}>
...
<div>
  ...
  >
    ...
    <section className="w-full bg-white py-16 md:py-20 pb-56 md:pb-52">
